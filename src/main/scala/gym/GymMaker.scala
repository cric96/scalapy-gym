...
/** the shape for a gym module. It is inspired by https://github.com/openai/gym/blob/master/gym/__init__.py the scope of
  ...
  * define what kind of environment the module might return.
  */
trait GymMaker {
  ...
  /** build an environment as gym.make(...) does, but partially typed. Actions and observations are considered python
    * value. Action space instead, are accessed type safely.
    * @param name
    *   the name of the environment selected
    * @return
    *   an instance of E
